...
%AKM: "main memory of the cluster" might ought to be "memory across the nodes of the cluster"
...
%AKM: Needs more introduction before jumping into GLM, unless the audience at NIPS will prefer to jump in and infer from there; I'm inclined to add a brief tour of the DSL.
